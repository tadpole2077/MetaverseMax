...
export class AlertHistoryComponent {
    ...
    constructor(public globals: Application, private alertManagerService: AlertManagerService, http: HttpClient, @Inject('BASE_URL') public rootBaseUrl: string, private alertSheet: MatBottomSheet) {
